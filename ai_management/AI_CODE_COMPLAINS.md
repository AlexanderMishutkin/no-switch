...
| C12 | “You did not get that all my old my complains as well as future one must be treated the same way!!” | User | Resolved | Updated `ai_management/AGENTS.md` to mandate identical handling for past and future complaints. |
