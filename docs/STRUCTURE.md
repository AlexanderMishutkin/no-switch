...
| `src/no_switch/poc.py` | Proof of concept | CLI entry point demonstrating how the chain loader and hotkey cycler work together. Lives with the package so it can import internal modules without needing editable installs. |
| `docs/` | Documentation | High-level architecture notes (`STACK.md`), agent descriptions (`AGENTS.md`), and this structure guide. |
